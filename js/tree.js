(function ($, Drupal, drupalSettings) {
        ...
        if (treeSettings instanceof Array) {
          for (let i = 0; i < treeSettings.length; i++) {
            ...
            $('#' + treeSettings[i].id).once('term-reference-fancytree').each(function () {
              new Drupal.TermReferenceFancyTree(treeSettings[i].id, treeSettings[i].name, treeSettings[i].source, treeSettings[i].select_children, treeSettings[i].select_parents);
   ...
   */
  Drupal.TermReferenceFancyTree = function (id, name, source, select_children, select_parents) {
